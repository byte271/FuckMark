...
Early durable-track *hypothesis* (sanitizer screen only, not a detector claim): U+034F COMBINING GRAPHEME JOINER and variation selectors U+FE00..U+FE0F. These are not product-authorized.
