...
Assigned width-0 insertions remain closed (H9). H12 control-code insertion (`Cc` DEL + C1 except NEXT LINE) is a new sanitizer-surviving research class. Independent seed `1100000` n=16 is control-mix **0/16** WM (`HYPOTHESIS`). It is not mix, not product-authorized, and does not rewrite the mix sanitizer FAIL. See `docs/cycle8/carrier-research.md`.
