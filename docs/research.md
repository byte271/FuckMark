...
| `cycle8-product-authorization-v2` | Live five-layer authorization | Public CLI applies mark plus C0/C1 plus Me plus Cf plus interlinear annotation (`release-cli-v11`) |
