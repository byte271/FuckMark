...
Ledger identity: `cycle7-seed-ledger-v3` (`fuckmark/cycle7/ledger.py`).
...
| Validation development (Stage C, reserved) | 880000 | **not yet inspected**; reserved until catalog v4 is frozen |
