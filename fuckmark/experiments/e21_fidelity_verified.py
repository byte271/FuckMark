...
from .e21_fidelity_summary import E21VerifiedFidelitySummary
...
def build_fidelity_bound_e21_headline_evidence(
    ...
    fidelity_summary: E21VerifiedFidelitySummary,
) -> tuple[E21HeadlineEvidence, ...]:
    if not isinstance(fidelity_summary, E21VerifiedFidelitySummary):
        raise TypeError("fidelity_summary must be an E21VerifiedFidelitySummary")
