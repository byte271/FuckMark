...
M10_RELEASE_ALGORITHM_VERSION = "m10-release-readiness-v1"
...
def build_m10_release_manifest(
    ...
    *,
    ...
    e20_result_hash = e20_completed_ledger.events[-1].artifact_hash
    if e20_result_hash != e20_result_bundle.bundle_hash:
    ...
    e21_result_hash = e21_completed_ledger.events[-1].artifact_hash
    if e21_result_hash != e21_result_bundle.bundle_hash:
