...
def build_verified_e21_replication_comparison(
    ...
    evidence = build_e21_headline_evidence(e21_analysis, e21_inference)
...
def verify_verified_e21_replication_comparison(
    ...
    if comparison != expected:
        raise E21ReplicationError("verified E21 replication comparison does not replay from analysis and inference artifacts")
