...
def global_seed_rows() -> tuple[dict[str, object], ...]:
    rows = (
        ...
        _row(930000, "cycle8", "scale_exploratory_development", CYCLE8_SCALE_EXPLORATORY_TOPIC, "global-seed-ledger-v1", generated=True, scored=True, publicly_exposed=False, spent=False, eligible_for_confirmation=False, eligible_as_unseen_validation=False, notes="Reserved before generation. U+034F x1 scale exploratory: 0/16 then 0/32 raw transformed WM. Not confirmation. Not unseen validation."),
