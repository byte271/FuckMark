...
CYCLE8_LEDGER_VERSION = "cycle8-seed-ledger-v1"
...
CYCLE7_UNSEEN_VALIDATION_SEED_BASE = 880_000

_ALL_BLOCKED = frozenset((*INHERITED_SPENT_SEED_BASES, CYCLE7_UNSEEN_VALIDATION_SEED_BASE))
...
def cycle8_seed_ledger_payload() -> dict[str, object]:
    return {
        ...
        "cycle7_unseen_validation_seed_base": CYCLE7_UNSEEN_VALIDATION_SEED_BASE,
        ...
        "selection_rule": (
            ...
            "any Cycle 8 text generation or detector look. Do not inspect 830000, "
            "840000, or 850000. Do not inspect Cycle 7 reserved validation seed "
            "880000 from Cycle 8. Do not retune on Cycle 6 formal residuals."
        ),
    }
