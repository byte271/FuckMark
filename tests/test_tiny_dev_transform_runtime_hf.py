...
from fuckmark.tiny_dev_transform_runtime_hf import (
    BASELINE_TINY_DEV_BUDGETS,
...
def test_budget_profiles_are_frozen_and_distinct() -> None:
    assert BASELINE_TINY_DEV_BUDGETS == (1, 2, 4)
    assert EXTENDED_TINY_DEV_BUDGETS == (1, 2, 4, 6)
    assert budget_profile("baseline") == BASELINE_TINY_DEV_BUDGETS
    assert budget_profile("extended") == EXTENDED_TINY_DEV_BUDGETS
