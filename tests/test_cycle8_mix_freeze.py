...
def test_mix_confirmation_seeds_are_preregistered_and_ungenerated() -> None:
    ...
    assert_cycle8_mix_confirmation_generation_seed(840000)
    assert_cycle8_mix_confirmation_generation_seed(850000)
