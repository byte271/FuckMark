...
- Latin letters outside ASCII, Han syllables, and emoji-only input are processed. Curly apostrophes stay in the visible text and are reported as `first_unsupported`. Joining scripts such as Arabic stay unchanged. Site cap is 4096 (five insertions per site).
